...
<Frame caption="Step 1 in Rekomi: copy your workspace's webhook URL.">
  <img
    ...
    src="https://rekomi-uploads-prod.nyc3.digitaloceanspaces.com/docs/screenshots/creem-integration/creem-step1-webhook-url.png?v=1"
...
<Frame caption="Step 2 in Creem: use Select All so the counter reads 13 of 13 events selected.">
  <img
    ...
    src="https://rekomi-uploads-prod.nyc3.digitaloceanspaces.com/docs/screenshots/creem-integration/creem-step2-webhook-events.png?v=1"
...
<Frame caption="Step 3 in Creem: tick READ on Products. Nothing else is needed.">
  <img
    style={{ borderRadius: "0.5rem" }}
    src="https://rekomi-uploads-prod.nyc3.digitaloceanspaces.com/docs/screenshots/creem-integration/creem-step3-api-key-scopes.png?v=1"
...
<Frame caption="Step 3 in Rekomi: paste the signing secret and API key, then connect.">
  <img
    style={{ borderRadius: "0.5rem", maxWidth: "640px" }}
    src="https://rekomi-uploads-prod.nyc3.digitaloceanspaces.com/docs/screenshots/creem-integration/creem-step3-connect-form.png?v=1"
...
- **After an outage, resend from Creem.** Creem retries for about an hour. Past that, resend the delivery from your Creem dashboard, and Rekomi will record it without duplicating anything.
