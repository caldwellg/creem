...
To switch to the test environment, click the **Test Mode** toggle in the bottom-left sidebar of your dashboard.

<img
  style={{ borderRadius: '0.5rem' }}
  src="/images/test-mode-toggle.png"
/>
...
Test and production environments use different API keys. You can find both keys in the [Developers section](https://creem.io/dashboard/developers). Make sure to toggle Test Mode in the bottom-left sidebar.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="credit-card"
    href="/features/one-time-payment"
  >
