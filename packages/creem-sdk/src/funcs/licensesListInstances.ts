 ...
 */
export function licensesListInstances(
  client: CreemCore,
  id: string,
  ...
  PageIterator<
    Result<
      operations.ListLicenseInstancesResponse,
      | CreemError
...
> {
  const input: operations.ListLicenseInstancesRequest = {
    id: id,
  ...
  const parsed = safeParse(
    input,
    (value) =>
      operations.ListLicenseInstancesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v1/licenses/{id}/instances")(pathParams);
  ...
  const [result, raw] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListLicenseInstancesResponse$inboundSchema, {
      key: "Result",
    }),
