...
* [getOrders](#getorders) - List customer orders
* [listSubscriptions](#listsubscriptions) - List customer subscriptions
* [listLicenses](#listlicenses) - List customer licenses
...
async function run() {
  const result = await creem.customers.getOrders("<id>");
...
```typescript
import { CreemCore } from "creem/core.js";
import { customersGetOrders } from "creem/funcs/customersGetOrders.js";
...
async function run() {
  const res = await customersGetOrders(creem, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("customersGetOrders failed:", res.error);
  }
}
...
async function run() {
  const result = await creem.customers.listSubscriptions("<id>");
...
```typescript
import { CreemCore } from "creem/core.js";
import { customersListSubscriptions } from "creem/funcs/customersListSubscriptions.js";
...
async function run() {
  const res = await customersListSubscriptions(creem, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("customersListSubscriptions failed:", res.error);
  }
}
...
async function run() {
  const result = await creem.customers.listLicenses("<id>");
...
```typescript
import { CreemCore } from "creem/core.js";
import { customersListLicenses } from "creem/funcs/customersListLicenses.js";
...
async function run() {
  const res = await customersListLicenses(creem, "<id>");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
    console.log("customersListLicenses failed:", res.error);
  }
}
...
```typescript
import { CreemCore } from "creem/core.js";
import { customersCreate } from "creem/funcs/customersCreate.js";
...
```typescript
import { CreemCore } from "creem/core.js";
import { customersUpdate } from "creem/funcs/customersUpdate.js";
