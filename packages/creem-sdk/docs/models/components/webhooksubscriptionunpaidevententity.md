...
```typescript
import { WebhookSubscriptionUnpaidEventEntity } from "creem/models/components";

let value: WebhookSubscriptionUnpaidEventEntity = {
  id: "<id>",
...
| `eventType`                                                                                                                          | [components.WebhookSubscriptionUnpaidEventEntityEventType](../../models/components/webhooksubscriptionunpaidevententityeventtype.md) | :heavy_check_mark:                                                                                                                   | The event name.                                                                                                                      |
