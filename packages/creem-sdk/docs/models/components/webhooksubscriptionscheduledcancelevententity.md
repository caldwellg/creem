...
```typescript
import { WebhookSubscriptionScheduledCancelEventEntity } from "creem/models/components";

let value: WebhookSubscriptionScheduledCancelEventEntity = {
  id: "<id>",
...
| `eventType`                                                                                                                                            | [components.WebhookSubscriptionScheduledCancelEventEntityEventType](../../models/components/webhooksubscriptionscheduledcancelevententityeventtype.md) | :heavy_check_mark:                                                                                                                                     | The event name.                                                                                                                                        |
