...
```typescript
import { WebhookSubscriptionPausedEventEntity } from "creem/models/components";

let value: WebhookSubscriptionPausedEventEntity = {
  id: "<id>",
...
| `eventType`                                                                                                                          | [components.WebhookSubscriptionPausedEventEntityEventType](../../models/components/webhooksubscriptionpausedevententityeventtype.md) | :heavy_check_mark:                                                                                                                   | The event name.                                                                                                                      |
