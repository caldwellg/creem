...
```typescript
import { WebhookSubscriptionCanceledEventEntity } from "creem/models/components";

let value: WebhookSubscriptionCanceledEventEntity = {
  id: "<id>",
...
| `eventType`                                                                                                                              | [components.WebhookSubscriptionCanceledEventEntityEventType](../../models/components/webhooksubscriptioncanceledevententityeventtype.md) | :heavy_check_mark:                                                                                                                       | The event name.                                                                                                                          |
