...
```typescript
import { WebhookSubscriptionEntity } from "creem/models/components";

let value: WebhookSubscriptionEntity = {
  id: "<id>",
  mode: "test",
  object: "subscription",
  product: {
...
| `product`                                                                                                    | [components.ProductEntity](../../models/components/productentity.md)                                         | :heavy_check_mark:                                                                                           | The product associated with the subscription.                                                                |                                                                                                              |
| `customer`                                                                                                   | [components.CustomerEntity](../../models/components/customerentity.md)                                       | :heavy_check_mark:                                                                                           | The customer who owns the subscription.                                                                      |                                                                                                              |
...
| `discount`                                                                                                   | [components.WebhookSubscriptionEntityDiscount](../../models/components/webhooksubscriptionentitydiscount.md) | :heavy_minus_sign:                                                                                           | The discount applied to the subscription, if any.                                                            |                                                                                                              |
