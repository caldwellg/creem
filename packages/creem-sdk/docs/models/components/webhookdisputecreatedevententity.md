...
```typescript
import { WebhookDisputeCreatedEventEntity } from "creem/models/components";

let value: WebhookDisputeCreatedEventEntity = {
  id: "<id>",
...
| `eventType`                                                                                                                  | [components.WebhookDisputeCreatedEventEntityEventType](../../models/components/webhookdisputecreatedevententityeventtype.md) | :heavy_check_mark:                                                                                                           | The event name.                                                                                                              |
| `createdAt`                                                                                                                  | *number*                                                                                                                     | :heavy_check_mark:                                                                                                           | Creation date of the event.                                                                                                  |
| `object`                                                                                                                     | [components.DisputeEntity](../../models/components/disputeentity.md)                                                         | :heavy_check_mark:                                                                                                           | Object related to the event.                                                                                                 |