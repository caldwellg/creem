...
```typescript
import { DisputeEntity } from "creem/models/components";

let value: DisputeEntity = {
  id: "<id>",
  mode: "test",
  object: "<value>",
  amount: 1000,
...
| `amount`                                                                              | *number*                                                                              | :heavy_check_mark:                                                                    | The disputed amount in cents. 1000 = $10.00                                           | 1000                                                                                  |
| `currency`                                                                            | *string*                                                                              | :heavy_check_mark:                                                                    | Three-letter ISO currency code, in uppercase. Must be a supported currency.           | USD                                                                                   |
| `transaction`                                                                         | [components.TransactionEntity](../../models/components/transactionentity.md)          | :heavy_check_mark:                                                                    | The transaction associated with the dispute.                                          |                                                                                       |
| `checkout`                                                                            | *components.DisputeEntityCheckout*                                                    | :heavy_minus_sign:                                                                    | The checkout associated with the dispute.                                             |                                                                                       |
| `order`                                                                               | *components.DisputeEntityOrder*                                                       | :heavy_minus_sign:                                                                    | The order associated with the dispute.                                                |                                                                                       |
| `subscription`                                                                        | *components.DisputeEntitySubscription*                                                | :heavy_minus_sign:                                                                    | The subscription associated with the dispute.                                         |                                                                                       |
| `customer`                                                                            | *components.DisputeEntityCustomer*                                                    | :heavy_minus_sign:                                                                    | The customer associated with the dispute.                                             |                                                                                       |
| `createdAt`                                                                           | *number*                                                                              | :heavy_check_mark:                                                                    | Creation date of the dispute as timestamp                                             |                                                                                       |