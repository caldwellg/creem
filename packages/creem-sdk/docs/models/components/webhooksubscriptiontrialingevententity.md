...
```typescript
import { WebhookSubscriptionTrialingEventEntity } from "creem/models/components";

let value: WebhookSubscriptionTrialingEventEntity = {
  id: "<id>",
...
| `eventType`                                                                                                                              | [components.WebhookSubscriptionTrialingEventEntityEventType](../../models/components/webhooksubscriptiontrialingevententityeventtype.md) | :heavy_check_mark:                                                                                                                       | The event name.                                                                                                                          |
