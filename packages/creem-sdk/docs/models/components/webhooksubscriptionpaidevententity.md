...
```typescript
import { WebhookSubscriptionPaidEventEntity } from "creem/models/components";

let value: WebhookSubscriptionPaidEventEntity = {
  id: "<id>",
...
| `eventType`                                                                                                                      | [components.WebhookSubscriptionPaidEventEntityEventType](../../models/components/webhooksubscriptionpaidevententityeventtype.md) | :heavy_check_mark:                                                                                                               | The event name.                                                                                                                  |
