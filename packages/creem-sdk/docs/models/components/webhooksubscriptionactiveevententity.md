...
```typescript
import { WebhookSubscriptionActiveEventEntity } from "creem/models/components";

let value: WebhookSubscriptionActiveEventEntity = {
  id: "<id>",
...
| `eventType`                                                                                                                          | [components.WebhookSubscriptionActiveEventEntityEventType](../../models/components/webhooksubscriptionactiveevententityeventtype.md) | :heavy_check_mark:                                                                                                                   | The event name.                                                                                                                      |
