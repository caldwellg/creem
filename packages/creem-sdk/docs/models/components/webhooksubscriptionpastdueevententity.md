...
```typescript
import { WebhookSubscriptionPastDueEventEntity } from "creem/models/components";

let value: WebhookSubscriptionPastDueEventEntity = {
  id: "<id>",
...
| `eventType`                                                                                                                            | [components.WebhookSubscriptionPastDueEventEntityEventType](../../models/components/webhooksubscriptionpastdueevententityeventtype.md) | :heavy_check_mark:                                                                                                                     | The event name.                                                                                                                        |
